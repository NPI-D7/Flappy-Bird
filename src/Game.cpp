...
void Game::Draw(void) const {
  ...
  if (tot) {
    board.Draw();
    Num::DrawMin((board.getPosX() + board.getWidth()) - 32, boardposy + 26,
                 sscore);
    Num::DrawMin((board.getPosX() + board.getWidth()) - 32, boardposy + 60,
                 best);
  ...
  bscr.Draw();
  RenderD7::Draw::TextCentered(0, 210, 0.8f, RenderD7::Color::Hex("#000000"),
