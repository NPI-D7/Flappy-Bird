...
void Game::Draw(void) const
{
    ...
    {
        plays.Draw();
        //RenderD7::DrawText(RenderD7::GetTextWidth(0.4f, "(c) .GEARS 2013, NPI-D7 2022"), 240 - RenderD7::GetTextHeight(0.4f, "(c) .GEARS 2013, NPI-D7 2022"), 0.4f, RenderD7::Color::Hex("#eeeeee"), "(c) .GEARS 2013, NPI-D7 2022");
    }
    if (!tot)
    {
        for (int i = 0; i < 2; i++)
